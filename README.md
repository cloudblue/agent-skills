...
| [`catalog`](catalog/) | Build a product end to end through the products tools — shell, items, the ordering / fulfillment / configuration parameter phases, templates, version publication. Skill: `connect-product-builder`. |
